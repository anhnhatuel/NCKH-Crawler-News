...
srciPhone11=[]
countPages=1
test=['https://vnexpress.net/tag/galaxy-note-8-155407','https://vnexpress.net/tag/galaxy-note-8-155407-p2',
      'https://vnexpress.net/tag/galaxy-note-8-155407-p3','https://vnexpress.net/tag/galaxy-note-8-155407-p4']
for i in test:
...
# Xuất ra file csv qua Pandas
    ...
    df.to_csv('GalaxyNote8.csv', index=False, encoding='utf-8-sig')
