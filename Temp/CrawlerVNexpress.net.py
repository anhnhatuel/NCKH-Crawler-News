...
srciPhone11=[]
countPages=1
requestsPages = requests.get('https://vnexpress.net/tag/iphone-11-978698')
...
#print(srciPhone11)
print(len(srciPhone11))
print(srciPhone11)

r = requests.get(srciPhone11)
...
df.to_csv('vnexpressCrawl.csv', index=False, encoding='utf-8-sig')

data = pd.read_csv("vnexpressCrawl.csv")
